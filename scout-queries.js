...
module.exports = [

  {
    ...
    exclude: ['casio','kids','childrens','lot','parts','repair','broken','replica','smartwatch','digital','fitbit','apple','wholesale','FREE SHIPPING FREE SHIPPING'],
    priceMin: 15,
    priceMax: 500,
    limit: 100,
  },

  {
    ...
    exclude: ['dish','case','barbie','doll','kids','childrens','lot','wholesale','replica','fashion jewelry','costume lot','mass','factory','brooch','broach','vase','box','organizer','holder','lapel'],
    priceMin: 10,
    priceMax: 500,
    limit: 100,
  },
