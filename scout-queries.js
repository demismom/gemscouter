...
module.exports = [
...

  {
    ...
    categoryId: '48579',
    conditions: ['USED'],
    requireOneOf: ['ring','necklace','vintage','antique','handmade','art deco','art nouveau','sterling','rare','gem','filigree','bakelite','enamel','mid century','folk','one of a kind','studio'],
    exclude: ['lot','wholesale','replica','fashion jewelry','costume lot','mass','factory','brooch','broach','vase','sign'],
    priceMin: 10,
    priceMax: 500,
    limit: 100,
  },

  {
    ...
    query: 'original painting vintage',
    categoryId: '60437',
    conditions: ['USED'],
    requireOneOf: ['modernist','impressionist','art nouveau','art deco','neoclassical','romantic','estate sale','provenance','original','signed','oil on canvas','oil on board','acrylic','watercolor','modern','folk art','listed artist','abstract','landscape','hand painted','one of a kind'],
...

  {
    ...
    query: 'vintage eyeglasses sunglasses',
    categoryId: '56185',
    conditions: ['USED'],
